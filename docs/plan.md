...
- 내부 저장 기술은 비공개; 외부에서는 "독점 LPG 유사 모델"로 평가
- W3C 비표준 — SPARQL, IRI, Linked Data 연계 없음
- **우리 프로젝트는 Foundry의 UX/개념을 참조하되 W3C 표준 호환성을 유지하는 방향으로 차별화**
...
| **Oxigraph** (RDF 저장소) | Rust 기반 고성능 SPARQL 1.1 엔드포인트. in-process Python 바인딩 지원. 진실 원본 |
...
### 인프라
- **Docker Compose**: Backend + Frontend + Oxigraph + Neo4j 컨테이너 구성
...
| [oxigraph](https://github.com/oxigraph/oxigraph) | 고성능 RDF 저장소 + SPARQL 1.1 엔드포인트 | RDF | MIT/Apache |
